erpnext.PointOfSale.Controller = class {
	...
	create_opening_voucher() {
		...
		primary_action: async function({ company, pos_profile, balance_details }) {
			...
			console.log("perfiles de pos",arrayForValidation);
			let tiendita = []
			...
			tiendita.forEach((item,index)=>{
				...
				if(item.fecha_cierre == moment(new Date()).format("YYYY-MM-DD")){
					msg = "Tiene un cierre de caja del dia de hoy. No podrá realizar ventas hasta el dia de mañana"
					frappe.throw({
						message: __(msg),
						indicator: 'red',
						title: __('Error'),
